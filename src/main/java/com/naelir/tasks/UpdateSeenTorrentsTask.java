...
public class UpdateSeenTorrentsTask implements ITask {
    ...
    public void run() {
        ...
        List<String> list250 = this.data.forUpdate
                .stream()
